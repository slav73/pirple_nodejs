...
server.router = {
  ...
  'categories/all': handlers.categoriesList,
  'categories/create': handlers.categoriesCreate,
  'categories/edit': handlers.categoriesEdit,
  ping: handlers.ping,
  'api/users': handlers.users,
  'api/tokens': handlers.tokens,
  'api/checks': handlers.checks,
  'api/categories': handlers.categories,
